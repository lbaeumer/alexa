...
public class OAuth2Callback
	...
	private static final Logger log = Logger
			.getLogger(OAuth2Callback.class.getName());
	...
	protected void onError(HttpServletRequest req, HttpServletResponse resp,
		...
		String nickname = UserServiceFactory.getUserService().getCurrentUser()
				.getNickname();
		resp.getWriter().print("<h3>" + nickname
	...
	protected String getRedirectUri(HttpServletRequest req)
			throws ServletException, IOException {
		String red = Utils.getRedirectUri(req);
		log.info("getRedirectUri=" + red);
		return red;
	}

	@Override
	protected AuthorizationCodeFlow initializeFlow() throws IOException {
		log.info("initializeFlow");
